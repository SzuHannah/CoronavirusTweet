...
#read data
library(rmarkdown)
wordfreq_bydateflo_top15_wocoron<-readRDS("./data/wordfreq_bydateflo_top15_wocoron.rds")
topiclswithlink<-readRDS("./data/topiclsbyflowithlink.rds")
tidypredcovds<-readRDS("./data/tidypredcovds.rds")
lmformds<-readRDS("./data/lmformds.rds")
wordpredictors<-readRDS("./data/wordpredictors.rds")
glmls<-readRDS("./data/glmoutput.rds")
#sentifment ds
uncombineds<-readRDS("./data/uncombineds.rds")
...
Sidebar {.sidebar}
=================================================================
### User Inputs (data available from 02/01 to 03/31)

```{r}
#usually i put input widgets here
dateInput('date',
      label = 'Date input (tweet explore):',
      value = '2020-02-01'
)

checkboxGroupInput("flock", label = 'flock of interest (tweet explore)', 
...
Tweet Wall and Spread of Covid-19 versus Topic clusters
=================================================================
...
Spread of Covid-19 versus Frequent words in tweets
=================================================================
Row{data-height=400}
-----------------------------------------------------------------------
